...
import { BoxBufferGeometry, Group } from 'three'
...
const roof = new THREE.Mesh(
    ...
    new THREE.MeshStandardMaterial({color: '#3D1C00'})
)
roof.position.y = 3 + .5
...
for(let i = 0; i < 25; i++){
    ...
    grave.position.set(x, .25, z)
    grave.rotation.y = (Math.random() - .5) * .25 
...
doorLight.position.set(0, 3, 2.7)
house.add(doorLight)
/**
 * Sizes
 */
